        ...
        <Carousel className=''>
            <Carousel.Item>
                ...
                <Carousel.Caption className=''>
                    <h2 className='text-info fs-1 fw-bolder'>A Culinary Journey through Japanese Cuisine</h2>
            ...
            <Carousel.Item>
                ...
                <Carousel.Caption className=''>
                    <h2 className='text-info fs-1 fw-bolder'>A Journey into Exquisite Culinary Traditions</h2>
            ...
            <Carousel.Item>
                ...
                <Carousel.Caption className=''>
                    <h2 className='text-info fs-1 fw-bolder'>Discover Authentic Japanese Food</h2>
